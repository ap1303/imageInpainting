...
from inpaintingui.control import InpaintingControl
    ...
    def run_algorithm(self):
        ...
        try:
            ok, msg = self.inpaintingControl.runAlgorithm(self.ids.imviewer,
                                                          maxIterations=self.inpaintingControl.maxIterations())
            if not ok:
            ...
            self.show_error_popup('algorithm failed!', 'Algorithm execution failed. For starters, please check the input images')
